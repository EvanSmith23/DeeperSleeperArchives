...
const IllustrationNoContent = (props) => {
  return (
    <div className="slds-illustration slds-illustration_small slds-p-top_x-large">
      <svg
      ...
      <div className="slds-text-longform">
        <h3 className="slds-text-heading_medium">{props.title}</h3>
        {props.details ? (
          <p className="slds-text-body_regular">{props.details}</p>
        ) : null}
        {props.children}
      </div>
    </div>
...
IllustrationNoContent.propTypes = {
